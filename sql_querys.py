...
TASK_2_QUERY = """
SELECT flight_no, COUNT(*) as count FROM flights 
...
INNER JOIN airports_data as arr ON flights.arrival_airport = arr.airport_code AND airports_data as dep ON flights.departure_airport = dep.airport_code
